    ...
    addonsList.innerHTML = addonsData.map(addon => `
      <div class="list-item">
        ...
        <div class="list-item-actions">
          <button class="btn-icon" onclick="editAddon('${addon.id}')">Edit</button>
          <button class="btn-icon" onclick="deleteAddon('${addon.id}')">Delete</button>
        </div>
      </div>
    `).join('');
  } catch (e) {
  ...
  try {
    ...
    iptvList.innerHTML = iptvData.map(iptv => `
      <div class="list-item">
        ...
        <div class="list-item-actions">
          <button class="btn-icon" onclick="editIptv('${iptv.id}')">Edit</button>
          <button class="btn-icon" onclick="deleteIptv('${iptv.id}')">Delete</button>
        </div>
      </div>
    `).join('');
  } catch (e) {
